		...
		<script type="text/javascript">
			$(document).ready(function(){
				$('img[name="search"]').click(function(){
					...
					window.location.href="file_m.jsp?search="+search;
				});
	...
	<body>
		...
		<div class="showb" align="center">
			<div class="classify" align="center" style="width:100%;height:150px;border-style:solid;border-width:0px 0px 1px 0px;border-color:#1fa5ff;">
				<span style="color:white;position:relative;top:30px;font-size:30px;">商品管理</span>
			</div>
			<table class="showtable" border="0">
			<tr style="color:#14a1ff;font-weight:bold;font-size:22px;"><td>产品号</td><td>产品名</td><td>价格</td><td>颜色</td><td>容量(G)</td><td>类型</td><td>已售</td><td>库存</td><tr>
