		...
		<script type="text/javascript">
			$(document).ready(function(){
				$('img[name="search"]').click(function(){
					...
					window.location.href="m_user.jsp?search="+search;
				});
	...
	<body>
		...
		<div class="showb" align="center">
			<div class="classify" align="center" style="width:100%;height:150px;border-style:solid;border-width:0px 0px 1px 0px;border-color:#1fa5ff;">
				<span style="color:white;position:relative;top:30px;font-size:30px;">用户账号管理</span>
			</div>
			<table class="showtable" border="0" cellspacing="5">
			<tr style="color:#14a1ff;font-weight:bold;font-size:22px;"><td>账号</td><td>密码</td><td>积分</td><td>折扣</td><tr>
